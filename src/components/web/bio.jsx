      ...
      <div className="grid grid-cols-1 md:grid-cols-2 bg-amber-50">
        ...
        <div className="flex items-center ">
          <p>
            ...
            ratione asperiores quibusdam, inventore magnam pariatur nihil ad
            doloremque temporibus eum, eius nobis quae perspiciatis voluptatem
            incidunt dolore! Ea, doloribus.
          </p>
        </div>
      </div>
    </div>
